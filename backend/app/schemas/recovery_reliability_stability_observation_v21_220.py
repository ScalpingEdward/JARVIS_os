...
class StabilityObservationRequest(BaseModel):
    ...
    min_consumer_stability_score: float = Field(default=0.85, ge=0.0, le=1.0)
    min_episode_stability_score: float = Field(default=0.90, ge=0.0, le=1.0)
    max_residual_risk: float = Field(default=0.15, ge=0.0, le=1.0)
