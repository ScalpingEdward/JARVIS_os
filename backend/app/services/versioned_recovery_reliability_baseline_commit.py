...
class RecoveryReliabilityBaselineProposal:
    ...
    def __post_init__(self) -> None:
        self.baseline_digest = _digest(self.baseline_payload())
...
class VersionedRecoveryReliabilityBaselineCommitGovernance:
    """Govern a versioned recovery-reliability baseline commit without runtime activation."""
    ...
    def _audit(self, record: RecoveryReliabilityBaselineProposal, action: str) -> None:
        record.baseline_digest = _digest(record.baseline_payload())
