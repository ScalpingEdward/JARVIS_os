...
@dataclass
class RecoveryReliabilityRolloutRecord:
    record_id: str
    workspace_id: str
...
class RecoveryReliabilityBaselineRolloutGovernance:
    """Govern staged rollout eligibility without mutating runtime consumers."""

    def __init__(self) -> None:
        self.records: dict[str, RecoveryReliabilityRolloutRecord] = {}
        self.source_ids: set[str] = set()
        self.audit: list[dict] = []

    def create(self, record: RecoveryReliabilityRolloutRecord, *, source_state: str, source_human_approved: bool) -> RecoveryReliabilityRolloutRecord:
        invalid = (
        ...
        if not record.stages or set(stage_consumers) != set(record.candidate_consumers) or len(stage_consumers) != len(set(stage_consumers)):
            invalid = True
    ...
    def approve_eligibility(self, record_id: str, *, actor: str, human_approved: bool) -> RecoveryReliabilityRolloutRecord:
    ...
    def approve_stage(self, record_id: str, *, stage: int, actor: str, human_approved: bool) -> RecoveryReliabilityRolloutRecord:
        record = self.records[record_id]
    ...
    def _audit(self, record: RecoveryReliabilityRolloutRecord, action: str) -> None:
