...
from ..executive_telegram_visual_signal_intelligence.api import router as executive_telegram_visual_signal_intelligence_router
...
router.include_router(executive_telegram_visual_signal_intelligence_router)
