...
from app.api.routes.auron_demo1_telegram_disclosure_retention_assurance_v21_344 import router as v21_344_router
from app.api.routes.auron_demo1_telegram_return_deletion_offboarding_v21_345 import router as v21_345_router
from app.api.routes.auron_demo1_telegram_post_offboarding_closure_v21_346 import router as v21_346_router
from app.api.routes.auron_demo1_telegram_closed_record_integrity_v21_347 import router as v21_347_router
from app.api.routes.auron_demo1_telegram_closed_record_remediation_reclosure_v21_348 import router as v21_348_router
from app.api.routes.auron_demo1_telegram_post_remediation_probation_certification_v21_349 import router as v21_349_router
from app.api.routes.auron_demo1_telegram_certified_reclosure_assurance_v21_350 import router as v21_350_router
from app.api.routes.auron_demo1_telegram_assurance_recertification_v21_351 import router as v21_351_router
from app.api.routes.auron_demo1_telegram_renewed_assurance_continuity_v21_352 import router as v21_352_router
from app.api.routes.auron_demo1_telegram_expired_baseline_restoration_v21_353 import router as v21_353_router
from app.api.routes.auron_demo1_telegram_successor_baseline_stabilization_v21_354 import router as v21_354_router
...
router.include_router(v21_344_router)
router.include_router(v21_345_router)
router.include_router(v21_346_router)
router.include_router(v21_347_router)
router.include_router(v21_348_router)
router.include_router(v21_349_router)
router.include_router(v21_350_router)
router.include_router(v21_351_router)
router.include_router(v21_352_router)
router.include_router(v21_353_router)
router.include_router(v21_354_router)
