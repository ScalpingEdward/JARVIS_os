...
from app.services.recovery_reliability_stability_observation_v21_200 import evaluate_stability

router = APIRouter(prefix='/recovery-reliability/v21.200', tags=['recovery-reliability-v21.200'])
