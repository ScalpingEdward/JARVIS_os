...
- Next after H27 merge: H28 — Research real-provider transport object injection design. Define the separately injectable concrete transport-object contract, exact H27-certified identity binding and zero-network pre-execution state before any injection gate.
