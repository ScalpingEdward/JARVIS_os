...
- Next after H18 merge: H19 — Research real-provider transport injection contract. Define the injectable transport interface and its fail-closed capability/endpoint/budget contract without yet enabling a concrete provider implementation.
