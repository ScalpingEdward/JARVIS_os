...
- Next after H36 merge: H37 — Research real-provider network execution boundary certification. Certify exact H36/H35/H34/H33/H32/H31/H30 lineage, one-shot consumption/expiry/revocation/read-only scope semantics and continued zero-consumed/zero-request-reserved/zero-network state before any execution gate.
