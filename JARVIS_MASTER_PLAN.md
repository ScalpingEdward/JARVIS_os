...
- Next after H22 merge: H23 — Research real-provider transport injection authorization gate. A clean H22 certification may produce a short-lived operator-bound authorization artifact only; concrete transport injection and network execution must remain separate later layers.
