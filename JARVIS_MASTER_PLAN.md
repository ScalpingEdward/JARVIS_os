...
- Next after H15 merge: H16 — Research real-provider canary execution boundary design. Define how an unexpired H15 token could be consumed exactly once by a separate execution boundary with endpoint/capability/request-budget enforcement, without yet implementing a concrete provider transport.
