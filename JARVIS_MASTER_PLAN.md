...
- Next after H24 merge: H25 — Research real-provider transport injection boundary certification. Certify exact H23 authorization binding, one-time consumption semantics, transport identity/lifecycle/revocation, request-budget/audit invariants and continued zero-injection/zero-network state before any concrete transport binding layer.
