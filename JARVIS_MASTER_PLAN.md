...
- Next after H19 merge: H20 — Research real-provider transport injection contract certification. Certify the H19 interface/contract against the exact H18 session and verify fail-closed endpoint/capability/budget/timeout/response-size semantics while keeping concrete transport absent.
