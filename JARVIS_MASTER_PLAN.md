...
- Next after H25 merge: H26 — Research real-provider transport binding gate. Consume one clean H25-certified H23 authorization exactly once to bind one revocable transport identity while keeping network execution behind a later explicit gate.
