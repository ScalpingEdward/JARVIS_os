...
- Next after H29 merge: H30 — Research real-provider transport object injection gate. Attach exactly one concrete read-only transport object to one clean H29-certified identity while keeping all network execution behind a later explicit gate.
