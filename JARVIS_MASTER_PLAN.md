...
- Next after H34 merge: H35 — Research real-provider network execution authorization certification. Certify exact H34/H33/H32/H31/H30 lineage, TTL/expiry/revocation/one-shot scope and continued zero-consumed/zero-network state before any execution-boundary layer.
