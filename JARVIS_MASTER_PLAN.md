...
- Next after H23 merge: H24 — Research real-provider transport injection boundary design. Define the exact authorization-consumption, injected-transport identity, lifecycle, revocation, request-budget and audit boundary while keeping concrete network execution behind a later explicit gate.
