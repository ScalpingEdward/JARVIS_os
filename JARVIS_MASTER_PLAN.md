...
- Next after B8 merge: B9 — controlled multi-account live-enablement architecture with explicit canary/account scopes, live adapter boundary, reconciliation proof, operator approval and kill-switch enforcement before any provider write path can be enabled.
