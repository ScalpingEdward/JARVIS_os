...
- Next after D19 merge: D20 — workflow policy/approval boundary with operator approval, workflow/provider scope checks and kill-switch controls before simulation or future execution.
