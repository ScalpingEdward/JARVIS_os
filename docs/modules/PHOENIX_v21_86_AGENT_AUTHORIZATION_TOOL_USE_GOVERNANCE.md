# PHOENIX v21.86 — Agent Authorization & Tool-Use Governance

## Purpose

PHOENIX v21.86 governs AI-agent authority, tool access, delegation, data access and high-impact autonomy. The module is an assurance and authorization layer only. It does not grant credentials, mutate tool permissions, execute agent actions, place orders or alter portfolio state.
...
v21.86 sits above v21.85 Change & Release Governance. v21.85 governs whether software/system changes are safe to release; v21.86 governs what AI agents are allowed to request or recommend once deployed. Agent authorization cannot override Risk Brain, compliance, cybersecurity, model-risk, data-governance, operational-resilience or release-governance hard blocks.
